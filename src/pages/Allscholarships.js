  ...
  return (
    <div className='scholar_section'>
        ...
        <div className='containerrr'>
          {
            currentPosts.map(card_dataa => {
              return(
                <All title = {card_dataa.title}  des = {card_dataa.description}/>
              )})
          }
          <Pagination totalPosts = {dataa.length} postsPerPage={postsPerPage} setCurrentPage={setCurrentPage} currentPage={currentPage}/>
        </div>
    </div>
  ) 
}
